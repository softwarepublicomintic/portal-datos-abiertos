...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  ...
  <script type="text/javascript">
      ...
      var contenedor = document.getElementsByClassName("field-collection-container");
      var i;
      for (i = 0; i < contenedor.length; i++) {
          contenedor[i].previousSibling.style.display = "block";
    }
  ...
  <script type="text/javascript">
       jQuery(document).ready(function() {
          jQuery(".star a").removeAttr("title");
